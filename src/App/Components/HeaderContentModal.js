...
const HeaderContentModal = ({ isOpen, onClose, initialContent = '', onSave, onPreview }) => {
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h2 className="text-lg font-semibold text-gray-800">Customise your header content</h2>
          <button
            onClick={handleClose}
