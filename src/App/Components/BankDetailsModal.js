...
const BankDetailsModal = ({ isOpen, onClose, initialContent = '', onSave, onPreview }) => {
  ...
  // Placeholder groups for bank details
  ...
  const handleClearContent = () => {
    if (window.confirm('Are you sure you want to clear all content?')) {
      ...
      // Call onSave with empty string to remove bank details from PDF
      if (onSave) {
        onSave('');
      }
    }
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h2 className="text-lg font-semibold text-gray-800">Customise your bank details</h2>
          <button
            onClick={handleClose}
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          ...
          <p className="mt-3 text-xs text-gray-500">
            Note: Use placeholders to insert dynamic bank information. These will be replaced with actual values in the PDF.
          </p>
        </div>
