...
const AnnexureContentModal = ({ isOpen, onClose, initialContent = '', onSave, onPreview }) => {
  ...
  // Placeholder groups for annexure content
  ...
  const handleClearContent = () => {
    if (window.confirm('Are you sure you want to clear all content?')) {
      ...
      // Call onSave with empty string to remove annexure from PDF
      if (onSave) {
        onSave('');
      }
    }
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h2 className="text-lg font-semibold text-gray-800">Customise your annexure content</h2>
          <button
            onClick={handleClose}
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          ...
          <p className="mt-3 text-xs text-gray-500">
            Note: Add annexure content including by-laws, clauses, and other organizational details. This will appear on a separate page at the end of the quote.
          </p>
        </div>
...
export default AnnexureContentModal;
