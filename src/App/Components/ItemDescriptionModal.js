...
const ItemDescriptionModal = ({ isOpen, onClose, initialContent = '', onSave, onPreview }) => {
  ...
  const placeholderGroups = {
    'Item Details': [
      ...
      { label: 'Item Unit', value: '{itemUnit}' }
    ],
    'Pricing': [
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h2 className="text-lg font-semibold text-gray-800">Customise Item Name & Description</h2>
          <button
            onClick={handleClose}
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          ...
          <p className="mt-3 text-xs text-gray-500">
            Note: This template will be applied to each item in the table. Use placeholders to display item-specific information.
          </p>
        </div>
